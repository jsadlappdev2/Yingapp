        ...
        public void OnClick(Android.Views.View view)
        {
            try
            {
                ...
                else
                {
                    ...
                    //below is original setting.
                    // voiceIntent.PutExtra(RecognizerIntent.ExtraLanguage, Java.Util.Locale.Chinese);

                    voiceIntent.PutExtra(RecognizerIntent.ExtraLanguage, new String[] { "en", "zh-CN" });
                    voiceIntent.PutExtra("android.speech.extra.EXTRA_ADDITIONAL_LANGUAGES", new String[] { "en", Java.Util.Locale.Chinese.ToString() });
